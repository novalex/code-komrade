...
var _require = require('electron'),
    ...
    contentTracing = _require.contentTracing;
...
function createWindow() {
  ...
  global.mainWindow = mainWindow; // Debugging.
...
app.on('ready', function () {
  ...
  if (isRoot) {
    ...
    dialog.showMessageBox(options, function () {// app.exit( 0 );
    }); // return;
  } // Init menu.


  createMenu(); // Init main window.
